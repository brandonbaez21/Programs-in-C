//Programa que sirve para crear y manejar una lista doblemente enlazada de números enteros con listado de ambos sentidos recursivo.
#include <stdio.h>
#include <conio.h>
#include <stdlib.h>
#include <iostream>
...
void recursividad1(dato* indice);
void recursividad2(dato* indice);
};
...
void dato::lista_datos1(void)
{
	...
	recursividad1(indice);
	
	cout << endl;
	system("pause");
	system("cls");
}
void dato::recursividad1(dato* indice)
{
	if(indice != NULL)
	{
		cout <<"\nDATO= " <<indice ->x;
		recursividad1(indice->sig);	
	}
}
...
//}
{
	...
	recursividad2(indice);
	
	cout << endl;
	system("pause");
	system("cls");
}
void dato::recursividad2(dato* indice)
{
	if(indice != NULL)
	{
		cout <<"\nDATO= " <<indice ->x;
		recursividad2(indice->ant);	
	}
}
